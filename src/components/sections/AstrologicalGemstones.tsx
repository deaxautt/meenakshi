...
const AstrologicalGemstones = () => {
  const planetaryGemstones = [
    {
      name: "Blue Sapphire",
      subtitle: "For Saturn (Shani)",
      image: "https://images.pexels.com/photos/68740/gemstone-gem-blue-sapphire-68740.jpeg"
    },
    {
      name: "Yellow Sapphire",
      subtitle: "For Jupiter (Guru)",
      image: "https://images.pexels.com/photos/1458867/pexels-photo-1458867.jpeg"
    },
    {
      name: "Ruby",
      subtitle: "For Sun (Surya)",
      image: "https://images.pexels.com/photos/1616793/pexels-photo-1616793.jpeg"
    },
    {
      name: "Pearl",
      subtitle: "For Moon (Chandra)",
      image: "https://images.pexels.com/photos/1154619/pexels-photo-1154619.jpeg"
    }
  ];

  const zodiacGemstones = [
    {
      name: "Emerald",
      subtitle: "For Taurus & Libra",
      image: "https://images.pexels.com/photos/1453008/pexels-photo-1453008.jpeg"
    },
    {
      name: "Coral",
      subtitle: "For Aries & Scorpio",
      image: "https://images.pexels.com/photos/1616294/pexels-photo-1616294.jpeg"
    },
    {
      name: "Diamond",
      subtitle: "For Virgo & Libra",
      image: "https://images.pexels.com/photos/1458867/pexels-photo-1458867.jpeg"
    },
    {
      name: "Hessonite",
      subtitle: "For Capricorn",
      image: "https://images.pexels.com/photos/1616793/pexels-photo-1616793.jpeg"
    }
  ];
    ...
    <section className="py-8 md:py-12 bg-white">
      <div className="container-custom">
        <div className="flex justify-between items-center mb-6 md:mb-8">
          <h2 className="text-xl font-bold">Astrological Gemstones</h2>
        ...
        <div className="space-y-6 md:space-y-12">
          ...
          <div className="bg-white rounded-xl md:rounded-2xl p-2 md:p-8 shadow-sm mx-1 md:mx-0">
            ...
            >
              {planetaryGemstones.map((gemstone, index) => (
          ...
          <div className="bg-white rounded-xl md:rounded-2xl p-2 md:p-8 shadow-sm mx-1 md:mx-0">
            <Swiper
              ...
              className="gemstones-carousel !px-1"
            >
              {zodiacGemstones.map((gemstone, index) => (
                <SwiperSlide key={index}>
                  <div className="bg-white rounded-lg overflow-hidden group">
                    <div className="relative aspect-square md:aspect-[3/4] overflow-hidden">
                      <img 
          ...
          <div className="relative aspect-[21/9] rounded-xl md:rounded-2xl overflow-hidden mx-1 md:mx-0">
            <img 
              ...
              alt="Astrological Gemstones Collection"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-transparent flex items-center">
              <div className="p-6 md:p-12">
                ...
                <p className="text-white/90 text-sm md:text-lg mb-4 md:mb-6">
                  Discover the power of planetary gemstones
                </p>
                <Link 
...
export default AstrologicalGemstones;